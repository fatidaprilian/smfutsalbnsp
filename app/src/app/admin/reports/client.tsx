  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8 print:hidden">
        <form onSubmit={handleSubmit} className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4" noValidate>
          <div>
            ...
            />
            {fieldErrors.startDate && (
              <p className="mt-1 text-xs text-red-600 font-medium">{fieldErrors.startDate[0]}</p>
            )}
          </div>
          <div>
            ...
            />
            {fieldErrors.endDate && (
              <p className="mt-1 text-xs text-red-600 font-medium">{fieldErrors.endDate[0]}</p>
            )}
          </div>
          <div>
